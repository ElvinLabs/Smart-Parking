...
status('Forbidden') // => 403
status(306) // throws, as it's not supported by nodeModel.js
```
...
This is saved so that codes are consistent even in older nodeModel.js versions.
...
[node-version-image]: http://img.shields.io/badge/nodeModel.js-%3E%3D_0.6-brightgreen.svg?style=flat
